...
async function resetMelvCherToLevel12() {
  console.log("🔧 Resetting Melv and Cher to Level 12 with 0/0...");
  ...
  try {
    ...
    // Level 12 entspricht Stage 12
    const targetLevel = 12;
    const targetStage = 12;
    ...
    if (melvProgression) {
      // Update stage history for stage 12
      ...
      console.log(`✅ Melv reset to Level 12 (Stage 12) with 0/0`);
    }
    ...
    if (cherProgression) {
      ...
      console.log(`✅ Cher reset to Level 12 (Stage 12) with 0/0`);
    }
